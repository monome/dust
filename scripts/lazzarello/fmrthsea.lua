...
function init()
  ...
  params:add_control("amp1", "Osc 1 amplitude", controlspec.new(0,1, "lin",0,1,"db"))
  params:set_action("amp1", function(x) engine.amp1(x) end)
  params:add_control("amp2", "Osc 2 amplitude", controlspec.new(0,1, "lin",0,1,"db"))
  params:set_action("amp2", function(x) engine.amp2(x) end)
  params:add_control("amp3", "Osc 3 amplitude", controlspec.new(0,1, "lin",0,1,"db"))
  params:set_action("amp3", function(x) engine.amp3(x) end)
  params:add_control("amp4", "Osc 4 amplitude", controlspec.new(0,1, "lin",0,1,"db"))
  params:set_action("amp4", function(x) engine.amp4(x) end)
  params:add_control("amp5", "Osc 5 amplitude", controlspec.new(0,1, "lin",0,1,"db"))
  params:set_action("amp5", function(x) engine.amp5(x) end)
  params:add_control("amp6", "Osc 6 amplitude", controlspec.new(0,1, "lin",0,1,"db"))
