...
function Ack.add_params()
  ...
  TODO: looping
    ...
    params:add_control(i..": vol", volume_spec, Formatters.default)
    ...
    --[[
    params:add_control(i..": filter mode", filter_mode_spec, Formatters.default)
    ...
    params:add_control(i..": delay send", send_spec, Formatters.default)
    params:set_action(i..": delay send", function(value) engine.delaySend(i-1, value) end)
    params:add_control(i..": reverb send", send_spec, Formatters.default)
