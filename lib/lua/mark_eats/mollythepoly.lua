...
function MollyThePoly.add_params()
  ...
  params:add{type = "control", id = "glide", name = "Glide", controlspec = specs.GLIDE, formatter = MEFormatters.format_secs, action = engine.glide}
  ...
  params:add{type = "control", id = "hp_filter_cutoff", name = "HP Filter Cutoff", controlspec = specs.HP_FILTER_CUTOFF, formatter = MEFormatters.format_freq, action = engine.hpFilterCutoff}
  params:add{type = "control", id = "lp_filter_cutoff", name = "LP Filter Cutoff", controlspec = specs.LP_FILTER_CUTOFF, formatter = MEFormatters.format_freq, action = engine.lpFilterCutoff}
  ...
  params:add{type = "control", id = "lfo_freq", name = "LFO Frequency", controlspec = specs.LFO_FREQ, formatter = MEFormatters.format_freq, action = engine.lfoFreq}
  ...
  params:add{type = "control", id = "env_1_attack", name = "Env-1 Attack", controlspec = specs.ENV_ATTACK, formatter = MEFormatters.format_secs, action = engine.env1Attack}
  params:add{type = "control", id = "env_1_decay", name = "Env-1 Decay", controlspec = specs.ENV_DECAY, formatter = MEFormatters.format_secs, action = engine.env1Decay}
  params:add{type = "control", id = "env_1_sustain", name = "Env-1 Sustain", controlspec = specs.ENV_SUSTAIN, action = engine.env1Sustain}
  params:add{type = "control", id = "env_1_release", name = "Env-1 Release", controlspec = specs.ENV_RELEASE, formatter = MEFormatters.format_secs, action = engine.env1Release}
  params:add_separator()
  
  params:add{type = "control", id = "env_2_attack", name = "Env-2 Attack", controlspec = specs.ENV_ATTACK, formatter = MEFormatters.format_secs, action = engine.env2Attack}
  params:add{type = "control", id = "env_2_decay", name = "Env-2 Decay", controlspec = specs.ENV_DECAY, formatter = MEFormatters.format_secs, action = engine.env2Decay}
  params:add{type = "control", id = "env_2_sustain", name = "Env-2 Sustain", controlspec = specs.ENV_SUSTAIN, action = engine.env2Sustain}
  params:add{type = "control", id = "env_2_release", name = "Env-2 Release", controlspec = specs.ENV_RELEASE, formatter = MEFormatters.format_secs, action = engine.env2Release}
  params:add_separator()
  ...
  params:add{type = "control", id = "ring_mod_freq", name = "Ring Mod Frequency", controlspec = specs.RING_MOD_FREQ, formatter = MEFormatters.format_freq, action = engine.ringModFreq}
